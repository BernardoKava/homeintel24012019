...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post deliveries_url, params: { delivery: { delivery_date: @delivery.delivery_date, owner: @delivery.owner, user_id: @delivery.user_id } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { delivery_date: @delivery.delivery_date, owner: @delivery.owner, user_id: @delivery.user_id } }
