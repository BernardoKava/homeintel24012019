...
class QualificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post qualifications_url, params: { qualification: { from: @qualification.from, grade: @qualification.grade, name: @qualification.name, school: @qualification.school, to: @qualification.to } }
    end
  ...
  test "should update qualification" do
    patch qualification_url(@qualification), params: { qualification: { from: @qualification.from, grade: @qualification.grade, name: @qualification.name, school: @qualification.school, to: @qualification.to } }
