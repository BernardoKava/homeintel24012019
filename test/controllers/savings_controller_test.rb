...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post savings_url, params: { saving: { month: @saving.month, name: @saving.name, saving_date: @saving.saving_date, user_id: @saving.user_id, year: @saving.year } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { month: @saving.month, name: @saving.name, saving_date: @saving.saving_date, user_id: @saving.user_id, year: @saving.year } }
