...
class EmploymentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment" do
    assert_difference('Employment.count') do
      post employments_url, params: { employment: { actve: @employment.actve, company: @employment.company, from: @employment.from, person_id: @employment.person_id, position: @employment.position, terminationreason: @employment.terminationreason, to: @employment.to, user_id: @employment.user_id } }
    end
  ...
  test "should update employment" do
    patch employment_url(@employment), params: { employment: { actve: @employment.actve, company: @employment.company, from: @employment.from, person_id: @employment.person_id, position: @employment.position, terminationreason: @employment.terminationreason, to: @employment.to, user_id: @employment.user_id } }
